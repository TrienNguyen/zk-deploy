...
public class Unit4 extends SelectorComposer<Component> {
	...
	public void Reload() {
		...
		} while (!(random_int != random_int0 && random_int0 != random_int1 && random_int1 != random_int));
	...
	public void onClickbtnNum0() {
		...
		if (rdChonSoLon.isChecked() == true) {
			if (Integer.valueOf(btnNum0.getLabel()) > Integer.valueOf(btnNum.getLabel())
					&& Integer.valueOf(btnNum0.getLabel()) > Integer.valueOf(btnNum1.getLabel())) {
				Dung++;
			} else {
				Sai++;
	...
	public void onClickbtnNum1() {
		Sum++;
		if (rdChonSoLon.isChecked() == true) {
			if (Integer.valueOf(btnNum1.getLabel()) > Integer.valueOf(btnNum0.getLabel())
					&& Integer.valueOf(btnNum1.getLabel()) > Integer.valueOf(btnNum.getLabel())) {
				Dung++;
			} else {
				Sai++;
				Messagebox.show("Sai rồi!", "Thông báo", Messagebox.OK, Messagebox.ERROR);
	...
	@Listen("onClick = #btnNum")
	public void onClickbtnNum() {
		Sum++;
		if (rdChonSoLon.isChecked() == true) {
			if (Integer.valueOf(btnNum.getLabel()) > Integer.valueOf(btnNum0.getLabel())
					&& Integer.valueOf(btnNum.getLabel()) > Integer.valueOf(btnNum1.getLabel())) {
				Dung++;
			} else {
				Sai++;
				Messagebox.show("Sai rồi!", "Thông báo", Messagebox.OK, Messagebox.ERROR);
